...
# META   "dependencies": {
# META     "lakehouse": {
# META       "default_lakehouse": "e77aad06-8094-47fb-82fd-887cdd864adc",
# META       "default_lakehouse_name": "wwilakehouse",
# META       "default_lakehouse_workspace_id": "c6b7d70d-b362-4def-868f-9e7d1b098d5e",
# META       "known_lakehouses": [
# META         {
# META           "id": "e77aad06-8094-47fb-82fd-887cdd864adc"
# META         }
# META       ]
# META     }
# META   }
...
def loadFullDataFromSource(table_name):
   ...
   df = df.drop("Photo")
   df.write.mode("overwrite").format("delta").option("overwriteSchema", "true").save("Tables/dbo/" + table_name)
